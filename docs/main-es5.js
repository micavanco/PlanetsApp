(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MainPageComponent = /** @class */ (function () {
                function MainPageComponent(planetsService, activatedRoute, router) {
                ...
                MainPageComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.routerSubscribe = this.activatedRoute.paramMap.subscribe(function (params) {
                        if (params.get('search')) {
                            _this.searchTerm = params.get('search');
                            localStorage.setItem('search', _this.searchTerm);
                            _this.onSearchTermChanged();
                        }
                    });
                    this.planetsService.getPlanetPicture().subscribe(function (data) { return _this.planetsPictures = data[0]; });
                };
                MainPageComponent.prototype.changeURL = function () {
                    if (!this.searchTerm)
                        this.searchTerm = ' ';
                    this.router.navigate(['/search/' + this.searchTerm]);
                };
                MainPageComponent.prototype.onSearchTermChanged = function () {
                    this.planets = [];
                    this.isLoading = true;
                    this.planetFound = true;
                    this.selectedPage = '1';
                ...
                MainPageComponent.prototype.getPlanetsData = function () {
                    var _this = this;
                    this.planetsService.getPlanet(this.searchTerm, this.selectedPage).subscribe(function (data) {
                        var _a, _b;
                        _this.planetsNames = [];
                        (_a = _this.planets).push.apply(_a, data['results'].filter(function (e) { return e.name !== 'unknown'; }));
                        (_b = _this.planetsNames).push.apply(_b, _this.planets.map(function (e) { return e.name; }));
                        if (data['next']) {
                            _this.selectedPage = data['next'].split('=')[1][0];
                            _this.getPlanetsData();
                        }
                    }, function (error) { return error; }, function () { _this.isLoading = false; _this.planetFound = _this.planets.length !== 0; });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Planet = /** @class */ (function () {
                function Planet(name, diameter, rotation_period, orbital_period, gravity, population, climate, terrain, surface_water, residents, films, url, created, edited) {
                    this.name = name;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PlanetDetailsComponent = /** @class */ (function () {
                function PlanetDetailsComponent(activatedRoute, router, planetsService) {
                    this.activatedRoute = activatedRoute;
                    this.router = router;
                    this.planetsService = planetsService;
                    this.planetPicture = '';
                ...
                PlanetDetailsComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.routerSubscribe = this.activatedRoute.paramMap.subscribe(function (params) {
                        _this.planetName = params.get('name');
                        _this.isLoading = true;
                        _this.planetSubscribe = _this.planetsService.getPlanet(_this.planetName, '1').subscribe(function (data) {
                            _this.planet = data['results'][0];
                        }, function (error) { }, function () {
                            _this.planetTerrainSubscribe = _this.planetsService.getTerrainPicture().subscribe(function (data) {
                                if (_this.planet.terrain.split(',')[0] !== 'unknown') {
                                    var terrainName = _this.planet.terrain.split(',')[0];
                                    if (terrainName[terrainName.length - 1] !== 's')
                                        terrainName += 's';
                                    var terrain = data[0][terrainName];
                                    var length = terrain['total_results'] < 80 ? terrain['total_results'] : 80;
                                    for (var i = 0; i < 4; i++) {
                                        var index = Math.floor((Math.random() * length));
                                        _this.terrainPictures.push(terrain['photos'][index]['src']['tiny']);
                                        _this.terrainURLs.push(terrain['photos'][index]['url']);
                                    }
                                }
                            }, function (error) { }, function () { return _this.isLoading = false; });
                        });
                        _this.planetPictureSubscribe = _this.planetsService.getPlanetPicture().subscribe(function (data) {
                            _this.planetPicture = data[0][_this.planetName];
                        });
                    });
                };
                ...
                PlanetDetailsComponent.prototype.onGoingBack = function () {
            ...
            PlanetDetailsComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var PlanetBoxComponent = /** @class */ (function () {
                function PlanetBoxComponent() {
                }
                return PlanetBoxComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ResultContainerComponent = /** @class */ (function () {
                ...
                ResultContainerComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.planetsModified = this.planets.filter(function (e, i) { return i >= _this.indexFrom && i <= _this.indexTo; });
                };
                ResultContainerComponent.prototype.onPageChanged = function (e) {
                    var _this = this;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SearchBarComponent = /** @class */ (function () {
                ...
                SearchBarComponent.prototype.onValueChanged = function () {
                    this.searchChange.emit(this.searchTerm);
                };
                SearchBarComponent.prototype.onOptionChanged = function (e) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PlanetsService = /** @class */ (function () {
                function PlanetsService(httpClient) {
                    this.httpClient = httpClient;
                }
                PlanetsService.prototype.transformToPlanet = function (data) {
                    return {
                        name: data['name'],
                ...
                PlanetsService.prototype.getPlanet = function (search, page) {
                ...
                PlanetsService.prototype.getPlanetPicture = function () {
                    return this.httpClient.get('../../assets/planets-pictures.json', {});
                };
                PlanetsService.prototype.getTerrainPicture = function () {
